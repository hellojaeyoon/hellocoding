...
- 다음은 CSS를 적용시키지 않은 Naver 홈페이지의 모습이다

![image-20201006220923324](CSS.assets/image-20201006220923324.png)

- 그리고 우리가 평소에 보는 Naver 홈페이지는 다음과 같다

![image-20201006220957959](CSS.assets/image-20201006220957959.png)

---

- 위 아래 둘 다 HTML 문서이지만, 위 HTML에 CSS(style & layout)를 적용해 아래와 같이 사람들에게 제공할 수 있다.

즉 CSS는 **스타일, 레이아웃을 통해 HTML을 표시하는 방법을 지정하는 언어** 이다
...
1. `Inline style` : 한 줄에 표현 - 그 요소 태그 안에 표현

   ![image-20201006222049688](CSS.assets/image-20201006222049688.png)

2. 내부 참조 (`Embedding style`) : Head에 style태그를 만들어 작성

   ![image-20201006222140019](CSS.assets/image-20201006222140019.png)



3. 외부 참조 (`Link style`) : 외부 CSS 파일을 `<head>`내 `<link>`를 통해 불러오기

   ![image-20201006222332849](CSS.assets/image-20201006222332849.png)
...
- 전체를 선택해 style을 적용시킬 수 있다(자주 쓰이진 않을것 같다)
